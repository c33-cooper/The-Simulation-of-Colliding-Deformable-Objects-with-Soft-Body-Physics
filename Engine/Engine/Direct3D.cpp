...
// Turn on the wireframe mode
void Direct3D::TurnOnWireframeMode()
{
	// set rasterizer state to wireframe
	m_deviceContext->RSSetState(m_rasterState);
}

// Turn off the wireframe mode
void Direct3D::TurnWireframeModeOff()
{
	// set rasterizer state to wireframe off
