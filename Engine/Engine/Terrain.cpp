// Filename: Terrain.cpp uses a bmp heightmap to generate
// the terrain - this technique was inspired by RasterTek.
#include "Terrain.h"
...
void Terrain::NormalizeHeightMap()
{
	...
	for(j=0; j<m_terrainHeight; j++)
	{
		for(i=0; i<m_terrainWidth; i++)
		{
			m_heightMap[(m_terrainHeight * j) + i].y /= 35.0f; // Change value for more rigid height map
		}														// or softer ridges
	}
