// Filename: QuadTree.h uses quad tree partitioning to render
// the correct amount pixels to the screen through the
// frustrum class. Also inspired by Rastertek.
#include "QuadTree.h"
...
void QuadTree::Render(Frustrum* frustum, ID3D11DeviceContext* deviceContext, TerrainShader* shader)
{
...
void QuadTree::RenderNode(NodeType* node, Frustrum* frustum, ID3D11DeviceContext* deviceContext, TerrainShader* shader)
{
	bool result;
