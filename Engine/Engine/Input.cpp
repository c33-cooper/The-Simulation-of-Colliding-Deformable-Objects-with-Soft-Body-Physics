...
{
	// Error handling result attribute
	HRESULT result;
...
// Shutdown input allocated memory
void Input::Shutdown()
{
	// Release the mouse.
	if(m_mouse)
...
// Update the input by ticking each frame
bool Input::Frame()
{
	bool result;
...
// Check whether eacape is pressed
...
// Is F2 key pressed on the keyboard
bool Input::IsF2Pressed()
{
