// GameObject.cpp is the implementation for the GameObject base class
...
{
	// Initialize pointers and members
	m_model = 0;
	m_vertexBuffer = 0;
	m_indexBuffer = 0;
...
bool GameObject::Initialize(ID3D11Device* device, char* filename)
{
	bool result;
...
// Update function updates GameObjects
void GameObject::Update(float dt, bool keydown)
{
	return;
}
...
// return center color of object
D3DXVECTOR4 GameObject::GetCenterColor()
{
	return m_centerColor;
}

// return outer color of object
D3DXVECTOR4 GameObject::GetApexColor()
{
	return m_apexColor;
}

// Load the model from .txt file
bool GameObject::LoadModel(char* filename)
{
	ifstream fin;
	char input;
	int i;
...
// Release the allocated memory of the model to prevent
// memory leaks
...
// Release graphics buffer memory
void GameObject::ReleaseBuffers()
{
...
// And finally render the buffers that have just been
// set up.
