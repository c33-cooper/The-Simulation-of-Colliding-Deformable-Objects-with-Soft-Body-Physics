// ShaderManagerClass.cpp is the implementation for the base shader class to interact
// with the graphics that are being rendered through the GPU.
...
bool ShaderManager::Initialize(ID3D11Device* device, HWND hwnd, 
	WCHAR* vertexShaderFileName, WCHAR* pixelShaderFileName,
	LPCSTR vertexShaderFunctionName, LPCSTR pixelShaderFunctionName)
{
	bool result;

	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, vertexShaderFileName, pixelShaderFileName,
		vertexShaderFunctionName, pixelShaderFunctionName);
	if (!result)
	{
		return false;
	}
...
bool ShaderManager::Render(ID3D11DeviceContext* deviceContext, int indexCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
	...
	LPCSTR vertexShaderFunctionName, LPCSTR pixelShaderFunctionName)
{
	...
	result = D3DX11CompileFromFile(vsFilename, NULL, NULL, vertexShaderFunctionName, "vs_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
	...
	result = D3DX11CompileFromFile(psFilename, NULL, NULL, pixelShaderFunctionName, "ps_5_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, NULL,
...
bool ShaderManager::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
	D3DXMATRIX projectionMatrix, D3DXVECTOR4 apexColor, D3DXVECTOR4 centerColor)
{
	HRESULT result;
